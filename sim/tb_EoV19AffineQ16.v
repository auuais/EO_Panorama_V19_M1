...
module tb_EoV19AffineQ16;
    ...
    initial begin
        // 237.4025268555 in Q16.16, +63 * 2.5625 pixels in EO's Q11.5 RowRun step.
        expected = 48'sd15558412 + 48'sd10579968;
        got = dut.affine_q16(32'sd15558412, 16'sd63, 16'sd82);
        if (got !== expected) begin
            $display("FAIL positive: got=%0d expected=%0d", got, expected);
            $fatal(1);
        end

        // Exercise sign extension with a negative Q11.5 RowRun step.
        expected = 48'sd10135975 - 48'sd1548288;
        got = dut.affine_q16(32'sd10135975, 16'sd63, -16'sd12);
        if (got !== expected) begin
            $display("FAIL negative: got=%0d expected=%0d", got, expected);
            $fatal(1);
        end

        $display("PASS: affine_q16 preserves signed RowRun increments");
        $finish;
    end
endmodule
