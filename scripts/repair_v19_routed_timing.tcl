...
set before_rpt [file join $impl_dir timing_before_repair.rpt]
set after_rpt [file join $impl_dir timing_after_repair.rpt]

if {![file exists $in_dcp]} {
    error "Routed checkpoint not found: $in_dcp"
}

set_param general.maxThreads 8
open_checkpoint $in_dcp
report_timing_summary -max_paths 10 -file $before_rpt

# Preserve placement and all RTL/IP configuration.  Only discard routing and
# reroute with the timing-focused directive; the observed violation is a
# single long MIG-calibration-to-XIPHY route and previous placements of the
# same design have met timing.
