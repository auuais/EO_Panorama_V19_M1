...
# regenerate it from the old x64 helper script. Bring-up/debug builds keep
# the ILA cores present; see docs/QSPI_NO_ILA_CLEANUP_MEMORY_20260811.md when
# a production QSPI image needs them stripped again.
foreach xci [list \
