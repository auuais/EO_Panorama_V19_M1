...
set strict_no_debug [expr {[lsearch -exact $argv "strict"] >= 0}]
...
puts "NO_ILA_CHECK strict=$strict_no_debug name_matches=[llength $name_matches] ref_matches=[llength $ref_matches] debug_cores=$debug_cores"
