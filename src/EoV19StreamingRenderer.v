...
module EoV19StreamingRenderer #(
    ...
    EoV19LineCache u_lc0(.rst_n(rst_n),.wr_clk(cam0_clk),.wr_hsync(cam0_hsync),.wr_vsync(cam0_vsync),.wr_pixel(cam0_pixel),.rd_clk(clk),.rd_x(rd_x0),.rd_y0(rd_y00),.rd_y1(rd_y01),.rd_pixel_y0(p00),.rd_pixel_y1(p01),.captured_rows(rows0),.frame_toggle(tog0));
    EoV19LineCache u_lc1(.rst_n(rst_n),.wr_clk(cam1_clk),.wr_hsync(cam1_hsync),.wr_vsync(cam1_vsync),.wr_pixel(cam1_pixel),.rd_clk(clk),.rd_x(rd_x1),.rd_y0(rd_y10),.rd_y1(rd_y11),.rd_pixel_y0(p10),.rd_pixel_y1(p11),.captured_rows(rows1),.frame_toggle(tog1));
    EoV19LineCache u_lc2(.rst_n(rst_n),.wr_clk(cam2_clk),.wr_hsync(cam2_hsync),.wr_vsync(cam2_vsync),.wr_pixel(cam2_pixel),.rd_clk(clk),.rd_x(rd_x2),.rd_y0(rd_y20),.rd_y1(rd_y21),.rd_pixel_y0(p20),.rd_pixel_y1(p21),.captured_rows(rows2),.frame_toggle(tog2));
    EoV19LineCache u_lc3(.rst_n(rst_n),.wr_clk(cam3_clk),.wr_hsync(cam3_hsync),.wr_vsync(cam3_vsync),.wr_pixel(cam3_pixel),.rd_clk(clk),.rd_x(rd_x3),.rd_y0(rd_y30),.rd_y1(rd_y31),.rd_pixel_y0(p30),.rd_pixel_y1(p31),.captured_rows(rows3),.frame_toggle(tog3));
    EoV19LineCache u_lc4(.rst_n(rst_n),.wr_clk(cam4_clk),.wr_hsync(cam4_hsync),.wr_vsync(cam4_vsync),.wr_pixel(cam4_pixel),.rd_clk(clk),.rd_x(rd_x4),.rd_y0(rd_y40),.rd_y1(rd_y41),.rd_pixel_y0(p40),.rd_pixel_y1(p41),.captured_rows(rows4),.frame_toggle(tog4));
    EoV19LineCache u_lc5(.rst_n(rst_n),.wr_clk(cam5_clk),.wr_hsync(cam5_hsync),.wr_vsync(cam5_vsync),.wr_pixel(cam5_pixel),.rd_clk(clk),.rd_x(rd_x5),.rd_y0(rd_y50),.rd_y1(rd_y51),.rd_pixel_y0(p50),.rd_pixel_y1(p51),.captured_rows(rows5),.frame_toggle(tog5));
