...
The proposed adaptive overlap warp is different. It uses a local two-dimensional deformation to make a rectangle look plausible. Because the deformation is concentrated where two cameras meet, it inherits all the problems of feature-dependent still-image stitching: depth dependence, moving-object sensitivity, seam shimmer, and loss of a stable pixel-to-ray interpretation. It can be offered as an optional view mode, but it should not replace the metric cylindrical mode used for measurement, stabilization, tracking, and any downstream analytics.
